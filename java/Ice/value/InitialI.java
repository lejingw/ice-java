...
class InitialI extends _InitialDisp {
	...
	@Override
	public void getPrinter(PrinterHolder impl, PrinterPrxHolder proxy, Ice.Current current) {
		impl.value = _printer;
	...
	@Override
	public void throwDerivedPrinter(Ice.Current current) throws DerivedPrinterException {
